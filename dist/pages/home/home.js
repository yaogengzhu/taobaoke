...
var Home = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(Home, [{
    ...
    key: "jumpToProductDetail",
    value: function jumpToProductDetail(item) {
      var goodsInfo = JSON.stringify(item);
      _index2.default.navigateTo({
  ...
  return Home;
}(_index.Component), _class.$$events = ["anonymousFunc0", "anonymousFunc1", "anonymousFunc2", "anonymousFunc3", "anonymousFunc4", "anonymousFunc5", "anonymousFunc6", "anonymousFunc7", "anonymousFunc8", "anonymousFunc9"], _class.$$componentPath = "pages/home/home", _temp2);
